...
class RefinedTrafficShockWaveDetector:
    ...
    def visualize_refined_results(self, station_data, station_name, shocks):
        ...
        if shocks:
            ...
            axes[1,0].set_title('衝擊波強度 vs 持續時間')
        ...
        axes[2,0].set_title('基本圖關係（衝擊波起始點標記為紅X）')
        ...
        if shocks:
            ...
            axes[2,1].set_title('每日衝擊波頻率')
            axes[2,1].set_ylabel('衝擊波數量')
