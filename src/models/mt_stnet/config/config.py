...
class parameter(object):
    def __init__(self,parser):
        ...
        self.parser.add_argument('--file_train_f', type=str, default='../../../data/Taiwan/train.csv',help='training set')
        self.parser.add_argument('--file_sp', type=str, default='../../../data/Taiwan/sp.csv', help='shortest path')
        self.parser.add_argument('--file_dis', type=str, default='../../../data/Taiwan/dis.csv', help='distance')
        self.parser.add_argument('--file_in_deg', type=str, default='../../../data/Taiwan/in_deg.csv', help='in degree')
        self.parser.add_argument('--file_out_deg', type=str, default='../../../data/Taiwan/out_deg.csv', help='out degree')
        self.parser.add_argument('--file_adj', type=str, default='../../../data/Taiwan/adjacent_fully.csv',help='adjacent')
        ...
        self.parser.add_argument('--site_num', type=int, default=62, help='total number of road')
        self.parser.add_argument('--edge_num', type=int, default=144, help='total number of edge')
